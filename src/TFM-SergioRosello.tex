...
Actualmente, la empresa tiene un pipeline de integración continua, en el que se pasan varios ``jobs'' o pruebas automáticas en cada commit que se sube al repositorio de código.
...
Dicho esto, es importante recordar que el desarrollo del pipeline debe seguir siempre el modelo de desarrollo de software que el mismo promueve, que es el desarrollo iterativo e incremental y su desarrollo no tiene fin.
