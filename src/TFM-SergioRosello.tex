...
A medida que se ha ido popularizando el concepto DevOps, empresas como Gitlab han proporcionado herramientas para llevar dicha idea a pequeñas y medianas empresas (Con la incorporación de su programa DevOps, DevSecOps, y pipelines) y estas han adaptado su ciclo de vida del este tipo de desarrollo de software, 
...
\subsection{La seguridad desde el punto de vista DevSecOps}

Al unificar el desarrollo ágil, la filosofía DevOps y la seguridad, aparece una nueva forma de desarrollo de software que no aliena el campo de la seguridad, llamada DevSecOps, y lo integra de pleno en el desarrollo de software como uno mas de los requisitos necesarios para construir el proyecto. 
A raíz de esta idea, nacen nuevos conceptos como los ``Abuser stories'' \cite{Bor2006} en el que se aplica la seguridad a conceptos previos, como los ``User Stories''.
...
Siguiendo el paradigma del desarrollo ágil con filosofía DevOps, este nuevo esquema propone a la seguridad como un factor igual de importante que el desarrollo o el despliegue.
Las ventajas de incluir el departamento de seguridad y la practica de seguridad en el desarrollo del software, son multiples.
La mas importante es sin duda que se transfiere la detección de fallos a una fase anterior.
Esto quiere decir que al revisar el software que se esta generando en ámbitos de seguridad, estos problemas no van a aparecer mas adelante en el ciclo de desarrollo del mismo, sino que aparecerán directamente en la primera fase (Commit) o segunda fase (testeo).
A diferencia del planteamiento inicial, el el que la seguridad forma parte del ciclo de mantenimiento.
...
%TODO Casos de uso en los que las empresas han desarrollado un trabajo de DevSecOps. Con referencias.
