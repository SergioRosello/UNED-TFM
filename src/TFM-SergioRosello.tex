...
La seguridad, y la metodología ágil de desarrollo.

Mi carrera profesional es comparativamente corta, a medida que ha ido
avanzando, he ido identificado ciertos aspectos de mis responsabilidades
laborales que me han llamado más la atención.  Siempre he sabido que uno de los
valores principales en torno a los que encauzo mi vida es el aprendizaje
continuo, esa es la razón principal por la que me he inscrito al master de
Ciberseguridad con la UNED mientras llevaba una vida laboral activa.  Durante el
estudio de las distintas asignaturas que forman el master, una de las que más ha
estimulado mi creatividad y aspiraciones futuras ha sido Auditoria y
monitorización de la seguridad
Este proyecto es la union de dos de mis intereses dentro del universo del
Software.
...
Dada la situación en la que me encuentro laboralmente, empleado como DevOps en
Scalefast, pienso que estoy en una situación única para poder observar gran
...
%TODO: Cambiar la cultura que debemos extender a los desarrolladores.
...
Continua, a un \gls{pipeline} que es útil en un mayor sector del ciclo de visa
de un proyecto, desde integración a despliegue continuos, sin dejar de lado el
desarrollo de software de forma segura.
Concretamente, el proyecto en el que me centrare yo sera en definir los pasos
relacionados con la \gls{App-Sec} que se van a ejecutar en el Pipeline.
Para realizar esta tarea, se crea una documentación gráfica, que describe las
fases clave de todo el ciclo de vida del desarrollo, no solo la parte
