...
La finalidad de la filosofía DevOps es establecer una comunicación constante entre las distintas fases y equipos de desarrollo.
...
El despliegue de una nueva funcionalidad se hace de forma iterativa e incremental, exactamente igual que el desarrollo de la misma.
...
En el desarrollo ágil, tenemos una serie de fases, definidas al inicio del proyecto.
Cada equipo %TODO: Finish
