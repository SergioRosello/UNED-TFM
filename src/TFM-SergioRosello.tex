...
Es importante mostrar la %TODO: Acabar

Una vez tengamos clara esta estructura, nos adentramos en dos de las
definiciones clave de este trabajo.
Estas son \gls{DevOps} y \gls{DevSecOps}.
De

La estructura de este documento sigue un orden
