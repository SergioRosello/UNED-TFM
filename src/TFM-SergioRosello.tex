...
%TODO: Darle mucha mas luz a esta sección 
...
\begin{figure}[H]
  \centering
  \subfloat[\centering DSOMM actual]{{\includegraphics[width=.45\linewidth]{DSOMM-filled} }}%
  \qquad
  \subfloat[\centering DSOWW esperado]{{\includegraphics[width=.45\linewidth]{DSOMM-expectations} }}%
...
%TODO: Configuración de security groups.
...
% Configuración del pipeline, para que acceda al runner
...
%TODO: Mostrar el código del pipeline que hace un ping al servidor de Vault


\subsubsection{Flujo de datos}

%TODO: Describir en detalle como se comunican todas las partes implicadas
