...
modelo de integración continua, pero despliegue manual, en el que la seguridad
entra en juego en la ultima fase del \gls{SDLC}, a un modelo \gls{DevSecOps}
...
La idea que se ha seguido a la hora de realizar este trabajo es definir las
características idílicas del \gls{SDLC} que guardan relación con \gls{App-Sec}.
